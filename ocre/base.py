...
class BaseRequest(UserString):
    """Makes web requests and can (if needed) parse HTML into BeautifulSoup
    ...
    Examples:
        >>> from ocre import BaseRequest
        >>> web_page = BaseRequest('https://stackoverflow.com')
        >>> print(web_page)
        ...
        ...     'delay': 4,
                ...
                'silent': True
        ... }
        >>> web_page = BaseRequest('https://stackoverflow.com', options=options)
        https://stackoverflow.com
    """ # noqa
